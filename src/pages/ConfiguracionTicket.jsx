          ...
          <Contentguia>
            ...
            <img
              ...
              style={{
                ...
                objectFit: "cover",      // rellena bien la imagen dentro del círculo
                border: "3px solid #4A90E2", // borde azul (cambia el color a tu gusto)
          ...
          <form className="receipt-content" onSubmit={handleSubmit(mutate)}>
            ...
            <div className="details-section">
              ...
              <div className="details-row">
                ...
                <div className="details-colon">:</div>
                <div className="details-value">18/09/2025</div>
                <div className="tech-label">
                  <span>Fecha</span>
